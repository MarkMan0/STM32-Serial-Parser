...
namespace pins {
  ...
  constexpr Pin_t
      ...
      SDA{ GPIOB_BASE,
          GPIO_InitTypeDef{ GPIO_PIN_7, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF4_I2C1 } },
      SCL{ GPIOB_BASE,
          GPIO_InitTypeDef{ GPIO_PIN_6, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_HIGH, GPIO_AF4_I2C1 } };
